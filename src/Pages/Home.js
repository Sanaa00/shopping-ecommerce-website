    ...
    <>
      <div className="h-screen bg-spi py-2 px-20">
        ...
        <div className="flex flex-col justify-between w-1/2 px-20">
          ...
          <button className="text-spi font-semibold text-xl shadow-lg bg-xanay px-10 py-2 rounded-full w-fit mt-10 transition ease-in-out delay-150   duration-300  hover:-translate-y-1 hover:scale-105 ">
            Add to cart
          </button>
        </div>
