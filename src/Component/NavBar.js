...
function NavBar({ shopItem }) {
  ...
  return (
    <>
      ...
      <div className="hidden sm:flex flex-row items-center justify-between bg-white text-rash bg-opacity-80 shadow-lg rounded-full md:text-xl font-semibold p-4 my-10 md:mx-20">
